...
function initPcoded() {
  ...
  window.font_change = font_change;
  ...
  window.preset_change = preset_change;
  ...
  window.layout_rtl_change = layout_rtl_change;
  ...
  window.layout_change = layout_change;
  ...
  window.change_box_container = change_box_container;
  // ----------    new setup end   ------------
